...
1. Describe the biggest difference between `.forEach` & `.map`.
    ...
    Map returns a new arry of elements while passing each element back to the callback
...
3. What is closure?
    ...
    functions do not have access to variables outside of their scope unless they are children of that scope
